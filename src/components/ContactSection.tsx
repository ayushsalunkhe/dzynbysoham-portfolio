...
export default function ContactSection() {
  ...
  return (
    ...
    >
      ...
      {/* Top divider */}
      <div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-2/3 h-px mb-0"
        style={{ background: "linear-gradient(to right, transparent, rgba(167,139,250,0.25), transparent)" }}
      />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          ...
          className="text-[#a78bfa] text-xs tracking-[0.35em] uppercase font-mono mb-6"
        >
          Let&apos;s Work Together
        </motion.p>
